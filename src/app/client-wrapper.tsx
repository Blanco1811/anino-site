  ...
  return (
    <LanguageProvider>
      <AuthProvider>
        ...
        >
          <span style={{ fontSize: '10px', fontWeight: 700, lineHeight: '12px' }}>Balance</span>
          <span style={{ marginTop: '2px', fontSize: '15px', fontWeight: 900, lineHeight: '16px' }}>100 $</span>
        </button>
      </AuthProvider>
    </LanguageProvider>
  );
